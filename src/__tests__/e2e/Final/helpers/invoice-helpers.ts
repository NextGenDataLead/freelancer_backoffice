...
export async function openInvoicingWizard(page: Page): Promise<void> {
  // Click "Start Invoice Wizard" button
  const wizardButton = page.locator('button:has-text("Start Invoice Wizard"), button:has-text("Factuurwizard"), button:has-text("Invoice Wizard")')
