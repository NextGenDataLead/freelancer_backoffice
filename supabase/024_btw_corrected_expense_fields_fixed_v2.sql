-- Migration: CORRECTED BTW expense fields for official Dutch VAT form compliance (FIXED v2)
...
-- FIXED v2: Uses actual expense_type enum values
...
-- Actual expense_type enum values: 'marketing', 'meals', 'office_supplies', 'other', 'professional', 'software', 'travel', 'utilities'
UPDATE expenses SET 
