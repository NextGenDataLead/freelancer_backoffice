-- Migration: 038 - Bulletproof Comprehensive Seed Data
-- Uses DELETE instead of TRUNCATE to avoid permission issues
...
-- ====================
-- CLEAR EXISTING DATA (using DELETE to avoid RLS issues)
-- ====================
...
DELETE FROM corporate_card_transactions;
DELETE FROM invoice_btw_classification;
DELETE FROM invoice_items;
DELETE FROM invoice_payments;
DELETE FROM kilometer_entries;
DELETE FROM icp_declarations;
DELETE FROM platform_subscription_payments;
...
DELETE FROM tenant_platform_subscriptions;
DELETE FROM organizations;
DELETE FROM documents;
DELETE FROM expense_categories;
DELETE FROM platform_subscription_plans;
DELETE FROM tenants;
