-- Migration: 036 - Corrected Comprehensive Seed Data
-- Fixes all enum type mismatches and missing schema columns from 032 migration
...
-- ====================
-- USER PROFILES (Updated with correct business_type enum)
-- ====================
...
-- ====================
-- EXPENSE CATEGORIES (Updated with correct Dutch expense_type enum and missing columns)
-- ====================
...
('cat11111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Reiskosten', 'Zakelijke reiskosten', 'reiskosten', NULL, true, '4121', NOW() - INTERVAL '6 months', NOW() - INTERVAL '6 months', '{}'),
('cat11111-1111-1111-1111-111111111112', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Kantoorbenodigdheden', 'Kantoorbenodigdheden en materialen', 'kantoorbenodigdheden', NULL, true, '4110', NOW() - INTERVAL '6 months', NOW() - INTERVAL '6 months', '{}'),
('cat22222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Software en ICT', 'Software licenties en ICT kosten', 'software_ict', NULL, true, '4140', NOW() - INTERVAL '1 year', NOW() - INTERVAL '1 year', '{}'),
('cat22222-2222-2222-2222-222222222223', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Marketing en Reclame', 'Marketing en reclame uitgaven', 'marketing_reclame', NULL, true, '4150', NOW() - INTERVAL '1 year', NOW() - INTERVAL '1 year', '{}'),
('cat33333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Professionele Diensten', 'Training en professionele ontwikkeling', 'professionele_diensten', NULL, true, '4160', NOW() - INTERVAL '2 years', NOW() - INTERVAL '2 years', '{}'),
('cat33333-3333-3333-3333-333333333334', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Software en ICT', 'IT infrastructuur en hosting', 'software_ict', NULL, true, '4140', NOW() - INTERVAL '2 years', NOW() - INTERVAL '2 years', '{}');
...
-- ====================
-- INVOICES (Updated with correct status and vat_type enums)
-- ====================
...
-- ====================
-- EXPENSES (Updated with correct expense_type, expense_status, and payment_method enums)
-- ====================
